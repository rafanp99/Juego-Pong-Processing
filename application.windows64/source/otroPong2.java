...
public class otroPong2 extends PApplet {
...
public boolean checkKey(String tecla){
...
public void addKeyHolding(char tecla){
  if(checkKey(""+tecla)){
    return;
  }
  keysMantenidas.add(""+tecla);
}
public void delKeyHolding(char tecla){
  for(int i=0;i<keysMantenidas.size();i++){
...
public void addScore(int playerN){
  if(playerN < 0){
    p2Score++;
  } else {
    p1Score++;
...
public void draw(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "otroPong2" };
    if (passedArgs != null) {
